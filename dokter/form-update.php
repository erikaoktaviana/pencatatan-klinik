			...
			<section>
				...
				<nav class="nav-content gap-5 mb-lg-4">
					<div class="d-flex gap-2 align-items-center">
						<div>
							<p class="title-content mb-2">Update Data Dokter</p>
						</div>
					</div>
				</nav>
				<div class="co-12">
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                <form action="update.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_dokter" value="<?=$data['nama_dokter'];?>" class="form-control" autocomplete="off">
                                    </div>
                                    <div class="mb-3">
                                        <label>Telp</label>
                                        <input type="text" name="telp" value="<?=$data['telp'];?>" class="form-control" autocomplete="off">
                                    </div>
									<div class="mb-3">
