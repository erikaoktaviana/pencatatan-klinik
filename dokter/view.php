    ...
    <div class="flex-1 p-6">
        <section>
            <div class="flex justify-between items-center">
                <p class="text-xl text-gray-700 font-bold mt-24"> ALL DOCTOR</p>  
                ...
                <table class="min-w-full bg-white border border-gray-100 rounded-lg overflow-hidden border-separate" style="border-spacing: 0">
                    ...
                    <tbody class="text-gray-700 text-base font-normal">
                        ...
                        <tr>
                            ...
                            <td class="p-3 border-b"><?= $data['telp']; ?></td>
                            <td class="p-3 border-b">
                                <a href="form-update.php?id_dokter=<?= $data['id_dokter']; ?>" class="text-blue-500 hover:text-blue-700 mx-2">
                                    <img src="../assets/images/edit.svg" class="w-4 h-4 inline" />
                                </a>
                                <a href="delete.php?id_dokter=<?= $data['id_dokter']; ?>" class="text-red-500 hover:text-red-700">
                        ...
                        <?php
                            ...
                            echo "<tr><td colspan='3' class='py-2 px-4 text-center border-b'>No Record Found</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
