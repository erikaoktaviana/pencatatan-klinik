			...
			<section>
				...
				<nav class="nav-content gap-5 mb-lg-4">
					<div class="d-flex gap-2 align-items-center">
						<div>
							<p class="title-content mb-2">Data Pasien</p>
						</div>
					</div>
					</div>
				</nav>
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $data)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $data['alamat']; ?></td>
                                                <td>
                                                    <a href="form-update.php?id_pasien=<?= $data['id_pasien']; ?>"class="icon-link mx-2" >
															<img src="../assets/images/edit.svg" alt="Pasien" />
													</a>
													<a href="delete.php?id_pasien=<?= $data['id_pasien']; ?>" class="icon-link">
