		...
		<aside class="sidebar offcanvas-lg offcanvas-start">
			...
			<nav class="menu flex-fill">
				<div class="section-menu">
					...
					<a href="../obat/view.php" class="item-menu active" onclick="handleClickMenu(this)">
					...
					<a href="../transaki/view.php" class="item-menu" onclick="handleClickMenu(this)">
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                <form action="update.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_obat" value="<?=$data['nama_obat'];?>" class="form-control" autocomplete="off">
                                    </div>
                                    <div class="mb-3">
                                        <label>Deskripsi</label>
                                        <input type="text" name="deskripsi" value="<?=$data['deskripsi'];?>" class="form-control" autocomplete="off">
                                    </div>
                                    <div class="mb-3">
                                        <label>Harga</label>
                                        <input type="text" name="harga" value="<?=$data['harga'];?>" class="form-control" autocomplete="off">
                                    </div>
                                    <div class="mb-3">
                                        <button type="submit" name="update" class="btn btn-cancel btn-transparent mb-2 float-end" style="background-color: #4640DE;color: white;">Update</button>
