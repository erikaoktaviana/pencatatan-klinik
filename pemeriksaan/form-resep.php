			...
			<section>
				...
				<nav class="nav-content gap-5 mb-lg-4">
					<div class="d-flex gap-2 align-items-center">
						<div>
							<p class="title-content mb-2">Input Resep</p>
						</div>
					</div>
				</nav>
				<div class="co-12">
                    ...
                    <div class="col mb-5 px-4">
                        <form action="save-resep.php" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="aturan_obat" class="form-control" autocomplete="off">
                            </div>
                            <div class="mb-4">
                                <label>Jumlah Obat</label>
                                <input type="text" name="jumlah_obat" class="form-control" autocomplete="off">
                            </div>
                            <div class="mb-4">
