		...
		<aside class="sidebar offcanvas-lg offcanvas-start">
			...
			<nav class="menu flex-fill">
				<div class="section-menu">
					...
					<a href="../pemeriksaan/view.php" class="item-menu active" onclick="handleClickMenu(this)">
			...
			<section>
				...
				<nav class="nav-content gap-5 mb-lg-4">
					<div class="d-flex gap-2 align-items-center">
						<div>
							<p class="title-content mb-2">Input Data Pemeriksaan</p>
						</div>
					</div>
				</nav>
				<div class="co-12">
					...
					<div class="col mb-5 px-4">
						<form action="save.php" method="POST">
							<section>
								...
								<div class="mb-4">
									<label>Tensi</label>
									<input type="text" name="tensi" class="form-control" autocomplete="off">
								</div>
								<div class="mb-4">
									<label>Keluhan</label>
									<input type="text" name="keluhan" class="form-control" autocomplete="off">
								</div>
								<div class="mb-4">
									<label>Diagnosa</label>
									<input type="text" name="diagnosa" class="form-control" autocomplete="off">
								</div>
								</section>
								<div class="mb-lg-4">
									<div>	
